        ...
        <div className="container max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white">Elite Transportation & Security for Distinguished Clients</h2>
              <p className="text-gray-400 leading-relaxed">
                Founded by a Marine veteran with extensive private security experience, HAUS delivers premium transportation and security services for those who demand excellence without compromise.
              </p>
              <p className="text-gray-400 leading-relaxed">
                We understand the unique needs of high-profile clients, executives, and discerning individuals who value privacy, safety, and luxury. Our commitment to discretion and professionalism has earned us the trust of clients worldwide.
              </p>
              <div className="pt-4">
            ...
            <div className="relative h-[400px] md:h-[500px]">
              <div className="absolute inset-0 glass-card overflow-hidden dot-pattern">
                <div className="absolute inset-0 rounded-xl overflow-hidden">
                  ...
                  <img 
                    src="https://images.unsplash.com/photo-1566933293069-b55c7f326dd4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80" 
