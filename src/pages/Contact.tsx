  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-20 bg-black relative">
        <div className="container max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center">
            <p className="text-haus-gold text-sm tracking-widest uppercase font-medium animate-fade-in">Get In Touch</p>
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="glass-card p-6 flex flex-col">
                  <div className="text-haus-gold mb-4">
                    <Phone size={28} />
                  </div>
              ...
              <div className="glass-card p-6 md:p-8">
                ...
                <a href="tel:+18005551234" className="text-haus-gold text-xl font-semibold hover:underline">+1 (800) 555-1234</a>
                <p className="text-gray-500 text-sm mt-2">Available 24/7 for clients with active services</p>
              </div>
            </div>
            
            <div className="glass-card p-8 md:p-10 luxury-shadow">
      ...
      <section className="py-12 bg-black relative">
        <div className="container max-w-7xl mx-auto px-6 md:px-12">
          <div className="glass-card overflow-hidden h-[400px] md:h-[500px] luxury-shadow">
            <iframe 
